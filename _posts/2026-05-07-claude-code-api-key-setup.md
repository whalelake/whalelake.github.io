...
faqs:
  - question: "이 글에서 가장 먼저 확인할 점은 무엇인가요?"
    answer: "먼저 핵심 개념과 실제 작업 환경에서 필요한 전제 조건을 확인하는 것이 좋습니다."
...
### 이 글에서 가장 먼저 확인할 점은 무엇인가요?

먼저 핵심 개념과 실제 작업 환경에서 필요한 전제 조건을 확인하는 것이 좋습니다.
